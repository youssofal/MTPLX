...
public final class MTPLXBackendStore: ObservableObject {
    ...
    func preflightConfiguredPort(
        ...
        case .externalMlxServeServer:
            // Raw health has no app ownership identity; never adopt or replace it.
